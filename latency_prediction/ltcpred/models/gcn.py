...
class GCN(Predictor):
    def __init__(self, depth, 
                    ...
                    initializer=None,
                    criterion_cfg=None):
        super(GCN).__init__(criterion_cfg)
        ...
        if initializer is not None:
            ...
            initialize(self.gcs, GraphConvolution, **initializer_gc['kwargs'])
            initializer_fc = initializer['fc']
            initialize(self.fc, nn.Linear,  **initializer_fc['kwargs'])
